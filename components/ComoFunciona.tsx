          ...
          {pasos.map((paso, index) => (
            <div key={paso.numero} className="relative">
              ...
              <div className="flex flex-col items-start">
                <div className="w-10 h-10 rounded-xl bg-brand-600 flex items-center justify-center mb-4 flex-shrink-0 shadow-md shadow-brand-600/25">
                  <span className="font-heading text-white text-xs font-bold">{paso.numero}</span>
                </div>
                <h3 className="font-heading font-bold text-gray-900 dark:text-white text-base mb-2 tracking-tight">{paso.titulo}</h3>
